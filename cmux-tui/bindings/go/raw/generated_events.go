...
// Mux protocol 12; IR SHA-256 a32cb8ec76bce28c995e39a62d6ea57136197ee7b173299dbc8f5c7f53ebdd47.
...
// PresenceChangedEvent is emitted by protocol v12.
...
func (value PresenceChangedEvent) MarshalJSON() ([]byte, error) {
	type wire PresenceChangedEvent
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Highlight.IsSet() {
		return nil, fmt.Errorf("encode PresenceChangedEvent: required nullable field highlight is missing")
	}
	if value.Highlight.IsNull() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceChangedEvent.Highlight: %w", err)
		}
		object["highlight"] = encodedField
	}
	if !value.Kind.IsSet() {
		return nil, fmt.Errorf("encode PresenceChangedEvent: required nullable field kind is missing")
	}
	if value.Kind.IsNull() {
		object["kind"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceChangedEvent.Kind: %w", err)
		}
		object["kind"] = encodedField
	}
	if !value.Name.IsSet() {
		return nil, fmt.Errorf("encode PresenceChangedEvent: required nullable field name is missing")
	}
	if value.Name.IsNull() {
		object["name"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceChangedEvent.Name: %w", err)
		}
		object["name"] = encodedField
	}
	if !value.Pointer.IsSet() {
		return nil, fmt.Errorf("encode PresenceChangedEvent: required nullable field pointer is missing")
	}
	if value.Pointer.IsNull() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceChangedEvent.Pointer: %w", err)
		}
		object["pointer"] = encodedField
	}
	if !value.Surface.IsSet() {
		return nil, fmt.Errorf("encode PresenceChangedEvent: required nullable field surface is missing")
	}
	if value.Surface.IsNull() {
		object["surface"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode PresenceChangedEvent.Surface: %w", err)
		}
		object["surface"] = encodedField
	}
	return json.Marshal(object)
...
func (value *PresenceChangedEvent) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode PresenceChangedEvent: expected object")
	}
	var fields struct {
		Client      *uint64                             `json:"client"`
		Color       *uint64                             `json:"color"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode PresenceChangedEvent: %w", err)
	}
	type wire PresenceChangedEvent
	var decoded wire
	if fields.Client == nil {
		return fmt.Errorf("decode PresenceChangedEvent: required field client is missing or null")
	}
	decoded.Client = *fields.Client
	if fields.Color == nil {
		return fmt.Errorf("decode PresenceChangedEvent: required field color is missing or null")
	}
	decoded.Color = *fields.Color
	if fields.Generation == nil {
		return fmt.Errorf("decode PresenceChangedEvent: required field generation is missing or null")
	}
	decoded.Generation = *fields.Generation
	if !fields.Highlight.IsSet() {
		return fmt.Errorf("decode PresenceChangedEvent: required field highlight is missing")
	}
	decoded.Highlight = fields.Highlight
	if !fields.Kind.IsSet() {
		return fmt.Errorf("decode PresenceChangedEvent: required field kind is missing")
	}
	decoded.Kind = fields.Kind
	if !fields.Name.IsSet() {
		return fmt.Errorf("decode PresenceChangedEvent: required field name is missing")
	}
	decoded.Name = fields.Name
	if !fields.Pointer.IsSet() {
		return fmt.Errorf("decode PresenceChangedEvent: required field pointer is missing")
	}
	decoded.Pointer = fields.Pointer
	if !fields.Surface.IsSet() {
		return fmt.Errorf("decode PresenceChangedEvent: required field surface is missing")
	}
	decoded.Surface = fields.Surface
	if fields.UpdatedAtMs == nil {
		return fmt.Errorf("decode PresenceChangedEvent: required field updated_at_ms is missing or null")
	}
	decoded.UpdatedAtMs = *fields.UpdatedAtMs
	*value = PresenceChangedEvent(decoded)
	return nil
}

func (PresenceChangedEvent) EventName() string { return "presence-changed" }
func (PresenceChangedEvent) isDeltaEvent()     {}
func (PresenceChangedEvent) isSubscribeEvent() {}
