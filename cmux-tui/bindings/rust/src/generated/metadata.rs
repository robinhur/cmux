...
pub const SDK_IR_SHA256: &str = "a32cb8ec76bce28c995e39a62d6ea57136197ee7b173299dbc8f5c7f53ebdd47";
...
#[rustfmt::skip]
pub const PRESENCE_CLEAR_METADATA: CommandMetadata = CommandMetadata {
    name: "presence-clear",
    since: 12,
    capability: Some("presence-v1"),
    authority: "control",
    stream: None,
};

#[rustfmt::skip]
pub const PRESENCE_LIST_METADATA: CommandMetadata = CommandMetadata {
    name: "presence-list",
    since: 12,
    capability: Some("presence-v1"),
    authority: "control",
...
#[rustfmt::skip]
pub const PRESENCE_UPDATE_METADATA: CommandMetadata = CommandMetadata {
...
#[rustfmt::skip]
pub const PRESENCE_CHANGED_EVENT_METADATA: EventMetadata = EventMetadata {
